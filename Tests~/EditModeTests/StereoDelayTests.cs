...
[TestFixture]
public class StereoDelayTests
{
    [Test] public void Constructor_DoesNotThrow()
        => Assert.DoesNotThrow(() => new StereoDelay(44100));

    [Test] public void Process_DoesNotThrow()
    {
        var d = new StereoDelay(44100);
    ...
    {
        // static buffer = data race when BGM engine and SFX engine both have StereoDelay.
        // Verify: two separate instances have independent buffers.
        var d1 = new StereoDelay(44100);
        var d2 = new StereoDelay(44100);
