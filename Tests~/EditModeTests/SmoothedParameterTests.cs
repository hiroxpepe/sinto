...
public class SmoothedParameterTests
{
    ...
    [Test] public void SnapToTarget_OnNoteOn_NoPyunArtifact()
    {
        ...
        var sp = new SmoothedParameter(0.1f);
        sp.SetTarget(0.9f);
    ...
    [Test] public void Constructor_ZeroSampleRate_ThrowsArgumentException()
        => Assert.Throws<System.ArgumentException>(() => new SmoothedParameter(0f, 20f, 0));
    ...
    [Test] public void Tick_AfterConvergence_DoesNotTriggerGC()
    {
        ...
        var sp = new SmoothedParameter(1.0f, smoothingHz: 20f, sampleRate: 44100);
        sp.SnapToTarget();
