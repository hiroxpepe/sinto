...
public class RingBufferTests
{
    ...
    public void Constructor_PowerOfTwo_DoesNotThrow(int capacity)
        => Assert.DoesNotThrow(() => new RingBuffer<int>(capacity));
    ...
    {
        var ex = Assert.Throws<ArgumentException>(() => new RingBuffer<int>(1000));
    ...
    {
        var buf = new RingBuffer<int>(1024);
    ...
    {
        var buf = new RingBuffer<int>(4); // usable = 3
    ...
    public void FieldLayout_HeadAndTail_AreAtLeast64BytesApart()
    {
        ...
        // RingBuffer<T> is a generic CLASS (reference type) — Marshal.OffsetOf would throw.
        ...
        var type = typeof(RingBuffer<int>);
    ...
    public void SPSC_100k_Operations_ZeroLoss()
    {
        ...
        var buf = new RingBuffer<int>(4096);
